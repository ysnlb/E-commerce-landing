...
- description: 2 إلى 4 فقرات قصيرة، كل فقرة في سطر مستقل (تتوزع الفقرات بين صور الصفحة).
- features: من 4 إلى 6 عناصر. icon لازم يكون من القائمة المسموحة فقط. label قصير (2-4 كلمات). description قصيرة تكمل الفكرة.
- announcement: شريط قصير أعلى الصفحة (تخفيض/توصيل)، مثال: "تخفيض 30% وتوصيل مجاني لكل الولايات".
- badge: شارة ثقة قصيرة، مثال: "الأكثر مبيعا في الجزائر".
- usage_steps: 2 إلى 4 خطوات استعمال بسيطة، كل خطوة في سطر مستقل.
- closing_line: جملة ختامية قوية تحمّس للشراء (بلا كلمة "اطلب" لأن الزر موجود تحتها).
ملاحظة: لا تخترع آراء زبائن.`
      ...
      generationConfig: {
        ...
        responseSchema: {
          ...
          properties: {
            ...
            badge: { type: 'STRING' },
            usage_steps: { type: 'STRING' },
            closing_line: { type: 'STRING' },
          },
          required: [
            'headline', 'subheadline', 'description', 'features',
            'announcement', 'badge', 'usage_steps', 'closing_line',
          ],
        },
        temperature: 0.9,
      },
